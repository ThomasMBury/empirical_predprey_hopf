...
dl = 1.10 # min value of dilution rate (control)
dh = 0.960 # max value of dilution rate (control)
dbif = 0.970 # bifurcation value
...
span = 0.4 # bandwidth
lags = [1,3,6] # autocorrelation lag times
...
df_ews.loc[plot_num,var][['Lag-1 AC','Lag-3 AC','Lag-6 AC']].plot(ax=axes[1], secondary_y=True,legend=True)
...
df_aic_t300 = df_temp[df_temp['Time']==319][['Realisation number','Variable','AIC fold','AIC hopf','AIC null']]
df_aic_t300.set_index(['Realisation number','Variable'], inplace=True)
