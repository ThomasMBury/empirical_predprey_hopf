...
columns=['Variable','Variance','Lag-1 AC',
         ...
         'Kurtosis','Skewness',
         'Smax']
df_ktau_hopf = pd.read_csv('../data_export/ews_trans_highhopf/ktau.csv',usecols=columns)[columns]
df_ktau_null = pd.read_csv('../data_export/ews_null_highhopf/ktau.csv',usecols=columns)[columns]
...
plt.plot(df_roc_ac1['fpr'], df_roc_ac1['tpr'], 'g', label = 'Lag-1 AC, AUC = %0.2f' % df_roc_ac1['auc'][0])
plt.plot(df_roc_ac3['fpr'], df_roc_ac3['tpr'], 'r', label = 'Lag-3 AC, AUC = %0.2f' % df_roc_ac3['auc'][0])
